...
import { RECORD_EXIT_SURVEY_QUERY } from "utils/gql-queries";
...
export default function ExitSurveyPage() {
  ...
  const [recordExitSurveyQuestionsToDb] = useMutation(RECORD_EXIT_SURVEY_QUERY);
  ...
  const onSubmit = async (data) => {
    ...
    await recordExitSurveyQuestionsToDb({
      variables: {
        ...
        attention_check: Number(data["attention_check"]),
        highest_degree: Number(data["highest_degree"]),
        num_accy_courses,
        num_fin_courses,
  ...
  return (
    <Layout>
      <main className={styles.exitSurvey}>
        <p>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className={styles.questionWrapper}>
            ...
            <div className={styles.optionsWrapper}>
              <label>
                <input
                  {...register("attention_check", { required: true })}
                  type="radio"
                  value={1}
                />
                <span className={styles.labelText}>Yes</span>
            ...
            {errors.attention_check && <ErrorMessageBox />}
          </div>
          ...
          <div className={styles.questionWrapper}>
            ...
            <div className={styles.optionsWrapper}>
              <label>
                <input
                  {...register("highest_degree", { required: true })}
                  type="radio"
                  value={0}
                />
                <span className={styles.labelText}>High school</span>
              </label>
              ...
              <label>
                <input
                  ...
                  value={1}
                />
                <span className={styles.labelText}>Associate degree</span>
              </label>
              ...
              <label>
                <input
                  ...
                  value={2}
                />
                <span className={styles.labelText}>Bachelor's degree</span>
              </label>
              ...
              <label>
                <input
                  ...
                  value={3}
                />
                <span className={styles.labelText}>Master's degree</span>
              </label>
              ...
              <label>
                <input
                  ...
                  value={4}
                />
                <span className={styles.labelText}>Doctorate degree</span>
              </label>
            </div>
            {errors.highest_degree && <ErrorMessageBox />}
          </div>
